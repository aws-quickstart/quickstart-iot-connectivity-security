...
. Sign in to your AWS account, and http://qs_launch_permalink[deploy the {partner-product-short-name} Quick Start into a new VPC^]. (http://qs_template_permalink[View the template^].) For details on this deployment option, see link:#_deployment_options[Deployment options] earlier in this guide.
