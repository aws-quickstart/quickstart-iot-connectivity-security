...
* An AWS CodeCommit repository with an AWS Amplify continuous integration and continuous delivery (CI/CD) pipeline. You can customize your web app by committing changes to the CodeCommit repository.
* An AWS Amplify continuous integration and continuous delivery (CI/CD) pipeline, used by the AWS CodeCommit repository. This pipeline allows to you custimze your web app by  
